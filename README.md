...
- Product website: [ones.com](https://ones.com)
- Documentation: [docs.ones.com](https://docs.ones.com)
...
- A `SKILL.md` file that defines the skill goal, scope, workflow, and operating rules
- Supporting references, assets, or agent configuration files when needed
- A dedicated `README.md` in the skill directory for human-readable introduction and usage guidance
...
1. Open a skill directory.
2. Read the skill's `README.md` for an overview and usage guidance.
3. Read `SKILL.md` for the exact operating instructions the agent should follow.
4. Use the referenced ONES product docs on [docs.ones.com](https://docs.ones.com) when you need broader product background.
...
- Easy to understand from the directory `README.md`
- Grounded in verifiable product behavior and documentation

## Learn More

- Product: [ones.com](https://ones.com)
- Docs: [docs.ones.com](https://docs.ones.com)
